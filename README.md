...
[![Version](https://img.shields.io/badge/version-0.12.0-68d7ff)](https://github.com/SysAdminDoc/OpenRadar/releases)
...
```powershell
Get-FileHash OpenRadar_0.12.0_x64-setup.exe -Algorithm SHA256
```
...
```powershell
.\OpenRadar_0.12.0_x64-setup.exe /S
.\OpenRadar_0.12.0_x64-setup.exe /S /D=C:\Tools\OpenRadar
```
