...
| `mesonet.agron.iastate.edu` | HRRR forecast reflectivity, the radar archive for replays, local storm reports, and the storm-based warning archive that draws the warnings in force during a replay | Free for any lawful purpose, no key | Iowa State Mesonet, in the timeline credit | Yes, through the native cache | The area and times you asked for, including which past event you replayed |
...
| `aviationweather.gov` | Surface observations (METAR) | US Government work, no key | NOAA Aviation Weather Center, in the popup | Yes, through the native cache | The area you have on screen, when surface observations are on |
