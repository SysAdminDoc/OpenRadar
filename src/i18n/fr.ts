...
export const fr: Catalogue = {
  ...
  "storm.status.TS": "Tempête tropicale",
  "storm.status.HU": "Ouragan",
  "storm.status.EX": "Extratropical",
  "storm.status.SD": "Dépression subtropicale",
  "storm.status.SS": "Tempête subtropicale",
  "storm.status.LO": "Basse pression",
  "storm.status.WV": "Onde tropicale",
  "storm.status.DB": "Perturbation",
  ...
  "kmz.damaged": "Le contenu de cette archive est endommagé.",
  ...
  "upload.dropChoose": "Choisir un fichier",
  "upload.dropBody":
  ...
  "product.vilDensity": "Densité de VIL",
  "product.hailSize": "Taille de la grêle",
  ...
  "radar.error.noSection":
    "{product} est déjà une réponse sur toute la colonne, il n’y a donc pas de coupe à prendre.",
  ...
  "radar.siteStopped": "{station} n'émet plus",
  "radar.holdInstead": "Garder {station} à la place",
  ...
  "keywords.night": "nuit jour obscurité soleil terminateur crépuscule",
  ...
  "keywords.stormCells": "orage trajectoire deplacement arrivee radar",
  "keywords.classification": "grele neige pluie classification radar",
  "keywords.probSevere": "violent grele vent tornade",
  "keywords.earthquakes": "tremblement terre magnitude usgs",
  ...
  "keywords.cocorahs": "pluie grele jardin cocorahs observateur releve",
  ...
  "keywords.lightningFlashes": "foudre satellite totale goes",
  ...
  "keywords.forecast": "meteo temperature pluie vent",
  ...
  "style.aerialDetail": "Imagerie USGS, États-Unis seulement",
  ...
  "layers.groupHazards": "Alertes et dangers",
  "layers.groupRadar": "Depuis le radar",
  "layers.groupWater": "Pluie et inondation",
  "layers.groupLightning": "Foudre",
  "layers.groupSky": "Ciel et air",
  "layers.groupReference": "Référence",
  "layers.groupYours": "Vos propres fichiers",
  ...
  "aviation.hazardConvective": "Orages",
  "aviation.hazardTurbulence": "Turbulence",
  "aviation.hazardTurbulenceHigh": "Turbulence en haute altitude",
  "aviation.hazardTurbulenceLow": "Turbulence en basse altitude",
  "aviation.hazardIcing": "Givrage",
  "aviation.hazardIfr": "Nuages bas ou mauvaise visibilité",
  "aviation.hazardMountains": "Montagnes masquées",
  "aviation.hazardShear": "Cisaillement de vent près du sol",
  "aviation.hazardSurfaceWind": "Vent fort en surface",
  "aviation.hazardFreezingLevel": "Isotherme 0",
  "aviation.hazardFreezingLevels": "Plus d'un isotherme 0",
  "aviation.hazardAsh": "Cendres volcaniques",
  "aviation.hazardMountainWave": "Onde orographique",
  "aviation.hazardTropicalCyclone": "Cyclone tropical",
  "aviation.hazardThunderstormHail": "Orages avec grêle",
  "aviation.hazardDustStorm": "Tempête de poussière",
  "aviation.hazardSandstorm": "Tempête de sable",
  "aviation.hazardRadioactiveCloud": "Nuage radioactif",
  "aviation.severityNone": "Aucune signalée",
  "aviation.severityTrace": "Traces",
  "aviation.severityTraceLight": "De traces à faible",
  "aviation.severitySmoothLight": "De nulle à faible",
  "aviation.severityHeavy": "Forte",
  "aviation.severityModerateExtreme": "De modérée à extrême",
  "aviation.severitySevereExtreme": "De forte à extrême",
  "aviation.severityExtreme": "Extrême",
  "aviation.pirepNothing": "Le pilote n’a signalé ni turbulence ni givrage.",
  "aviation.severityLight": "Légère",
  "aviation.severityLightModerate": "De légère à modérée",
  "aviation.severityModerate": "Modérée",
  "aviation.severityModerateSevere": "De modérée à sévère",
  "aviation.severitySevere": "Sévère",
  "aviation.forecastAhead":
    "{count, plural, one {Prévision pour dans une heure} other {Prévision pour dans # heures}}",
  "aviation.severity": "Intensité : {severity}",
  "aviation.freezingLevel": "Isotherme 0 à {high} ft",
  "aviation.feet": "{feet} ft",
  "aviation.sfc": "la surface",
  "aviation.fzl": "l’isotherme 0",
  "aviation.between": "{low} à {high}",
  "aviation.upTo": "Jusqu’à {high}",
  "aviation.atLevel": "Signalé à {high}",
  "aviation.from": "À partir de {low} vers le haut",
  ...
  "buoys.station": "Bouée {station}",
  "buoys.wind": "Vent",
  "buoys.windFrom": "{speed} de {from}°",
  "buoys.gusting": ", rafales à {speed}",
  "buoys.waves": "Vagues",
  "buoys.wavesAt": "{height} toutes les {seconds} sec",
  "buoys.pressure": "Pression",
  "buoys.water": "Eau",
  "buoys.air": "Air",
  ...
  "airnow.measuredOn": "Mesuré le {day} à {clock}",
  ...
  "layers.satelliteDetail":
    "Imagerie satellite sous le radar, depuis celui de GOES-East, GOES-West ou Himawari qui couvre la vue",
  ...
  "settings.reading": "Affichage",
  "settings.readingDetail": "La langue, les unités, l'heure et la taille",
  "settings.desktop": "Bureau",
  "settings.desktopDetail":
    "Windows, la zone de notification et le second écran",
  "settings.character": "Personnalité",
  "settings.characterDetail":
    "Ce que l'application propose d'elle-même, et rien pendant une alerte",
  ...
  "bar.nearbyShort": "Autour",
  "bar.sectionShort": "Coupe",
  "bar.mapTypeShort": "Carte",
  ...
  "legend.spikeMark":
    "Marque blanche : pic de diffusion à trois corps, signature de gros grêlons en altitude, pas une confirmation",
  "legend.echoTopped":
  ...
  "chrome.column": "VOLUME ENTIER",
  "chrome.columnHistorical": "VOLUME ENTIER, ARCHIVE",
  "chrome.columnLoop": "VOLUME ENTIER · VOLUME {index} SUR {count}, {time}",
  "chrome.columnLive": "VOLUME ENTIER · DIRECT, IL Y A {seconds} S",
  ...
  "curiosity.forgotten": "Les lieux que vous aviez trouvés sont oubliés",
  "curiosity.forgottenBody":
    "Rien ne les marque sur la carte : les retrouver veut dire aller regarder de nouveau.",
  ...
  "tides.noPredictions":
    "Cette station ne publie pas de prédictions de marée : il n'y a rien à dessiner. Essayez une autre station le long de la côte.",
  ...
  "tides.observed": "Mesuré {height}",
  "tides.observedAt": "Au marégraphe, {time}",
  "tides.abovePrediction": "{height} au-dessus des {predicted} prévus",
  "tides.belowPrediction": "{height} en dessous des {predicted} prévus",
  ...
  "keywords.tides": "haute basse cote eau niveau",
  ...
  "radar.rainviewerEmpty":
    "La source radar de secours a répondu sans rien à dessiner.",
