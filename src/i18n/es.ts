...
export const es: Catalogue = {
  ...
  "storm.status.TS": "Tormenta tropical",
  "storm.status.HU": "Huracán",
  "storm.status.EX": "Extratropical",
  "storm.status.SD": "Depresión subtropical",
  "storm.status.SS": "Tormenta subtropical",
  "storm.status.LO": "Baja presión",
  "storm.status.WV": "Onda tropical",
  "storm.status.DB": "Perturbación",
  ...
  "alerts.failed": "El servicio meteorológico {answer}.",
  "alerts.officeMissing":
    "No se pudo contactar con {office}, así que sus avisos no están en el mapa.",
  ...
  "earthquakes.failed": "El servicio de sismos del USGS {answer}.",
  "smoke.failed": "El análisis de humo de la NOAA {answer}.",
  "tropical.failed": "El National Hurricane Center {answer}.",
  "wildfires.failed": "El servicio de incendios del NIFC {answer}.",
  "hrrr.failed": "El índice del pronóstico {answer}.",
  "provider.failed": "El servicio de radar {answer}.",
  "route.forecastFailed": "El pronóstico {answer}.",
  "search.failed": "La búsqueda de lugares {answer}.",
  "weather.failed": "El pronóstico {answer}.",
  "replay.archiveFailed": "El archivo de avisos {answer}.",
  "kmz.notZip": "Ese archivo no es un zip.",
  "kmz.noDecompressor": "Esta versión no puede descomprimir un zip.",
  "kmz.tooBigUnpacked":
    "Ese archivo se descomprime a más de lo que se puede leer.",
  ...
  "kml.notKml": "Ese archivo no es un documento KML.",
  ...
  "vwp.noData": "ND",
  "vwp.nothingToDraw":
    "Los volúmenes llegaron sin viento dentro, así que todavía no hay nada que dibujar aquí.",
  "vwp.historical":
  ...
  "layer.lightningForecast": "Probabilidad de rayos",
  "layer.lightningJump": "Salto de rayos",
  "layer.isothermReflectivity": "Reflectividad en el nivel de hielo",
  ...
  "layers.lightningJumpDetail":
    "Dónde la tasa de descargas de una celda ha subido más rápido que su propio historial",
  "layers.isothermReflectivityDetail":
    "Reflectividad al nivel donde el aire está lo bastante frío para formar hielo",
  "layers.lightningWindow": "Promediado en",
  "layers.lightningWindowDetail":
    "Las cuatro son una tasa de descargas, así que puedes pasar de una a otra y compararlas",
  "layers.lightningForecastWindow": "Pronóstico para los próximos",
  "layers.lightningForecastWindowDetail":
    "Es un pronóstico, no una descarga. Cubre terreno donde no ha caído nada.",
  "layers.lightningJumpWindow": "Salto mostrado",
  "layers.lightningJumpWindowDetail":
    "En desviaciones estándar. A partir de dos, la formación del servicio meteorológico dice que hay que mirar.",
  "layers.isothermLevel": "Medido a",
  "layers.isothermLevelDetailMinus10":
    "Donde arrancan los rayos. Un eco fuerte aquí indica que la carga se está separando.",
  "layers.isothermLevelDetailMinus20":
    "Más adentro del hielo. Un eco fuerte aquí acompaña al granizo y a un salto en las descargas.",
  ...
  "lightningJump.now": "Ahora",
  "lightningJump.max": "Últimos 5 min",
  "isothermLevel.minus10": "−10 °C",
  "isothermLevel.minus20": "−20 °C",
  "mrms.lightning1min": "Rayos nube-tierra, 1 min",
  "mrms.lightning15min": "Rayos nube-tierra, 15 min",
  "mrms.lightning30min": "Rayos nube-tierra, 30 min",
  "mrms.lightningProbability30": "Probabilidad de rayos en 30 min",
  "mrms.lightningProbability60": "Probabilidad de rayos en 60 min",
  "mrms.lightningJump": "Salto de rayos",
  "mrms.lightningJumpMax": "Mayor salto de rayos, 5 min",
  ...
  "age.hours": "{count, plural, one {# hora} other {# horas}}",
  "age.days": "{count, plural, one {# día} other {# días}}",
  "time.ago": "hace {age}",
  ...
  "upload.exportPalette": "Guardar como archivo: {name}",
  ...
  "layer.vilDensity": "Densidad de líquido",
  "layer.shi": "Índice de granizo severo",
  "layer.posh": "Probabilidad de granizo",
  ...
  "keywords.posh": "probabilidad de granizo severo",
  "keywords.shi": "granizo severo energia cinetica witt",
  "keywords.vilDensity": "vil densidad columna granizo",
  "keywords.vii": "hielo integrado verticalmente congelado granizo",
  ...
  "layers.groupHazards": "Avisos y peligros",
  "layers.groupRadar": "Del radar",
  "layers.groupWater": "Lluvia e inundación",
  "layers.groupLightning": "Rayos",
  "layers.groupSky": "Cielo y aire",
  "layers.groupReference": "Referencia",
  "layers.groupYours": "Tus propios archivos",
  ...
  "aviation.hazardConvective": "Tormentas",
  "aviation.hazardTurbulence": "Turbulencia",
  "aviation.hazardTurbulenceHigh": "Turbulencia en niveles altos",
  "aviation.hazardTurbulenceLow": "Turbulencia en niveles bajos",
  "aviation.hazardIcing": "Engelamiento",
  "aviation.hazardIfr": "Nubes bajas o mala visibilidad",
  "aviation.hazardMountains": "Montañas cubiertas",
  "aviation.hazardShear": "Cizalladura cerca del suelo",
  "aviation.hazardSurfaceWind": "Viento fuerte en superficie",
  "aviation.hazardFreezingLevel": "Isoterma cero",
  "aviation.hazardFreezingLevels": "Más de una isoterma cero",
  "aviation.hazardAsh": "Ceniza volcánica",
  "aviation.hazardMountainWave": "Onda de montaña",
  "aviation.hazardTropicalCyclone": "Ciclón tropical",
  "aviation.hazardThunderstormHail": "Tormentas con granizo",
  "aviation.hazardDustStorm": "Tormenta de polvo",
  "aviation.hazardSandstorm": "Tormenta de arena",
  "aviation.hazardRadioactiveCloud": "Nube radiactiva",
  "aviation.severityNone": "Ninguna reportada",
  "aviation.severityTrace": "Trazas",
  "aviation.severityTraceLight": "De trazas a ligera",
  "aviation.severitySmoothLight": "De nula a ligera",
  "aviation.severityHeavy": "Fuerte",
  "aviation.severityModerateExtreme": "De moderada a extrema",
  "aviation.severitySevereExtreme": "De severa a extrema",
  "aviation.severityExtreme": "Extrema",
  "aviation.pirepNothing": "El piloto no reportó turbulencia ni engelamiento.",
  ...
  "buoys.station": "Boya {station}",
  "buoys.wind": "Viento",
  "buoys.windFrom": "{speed} del {from}°",
  "buoys.gusting": ", con rachas de {speed}",
  "buoys.waves": "Oleaje",
  "buoys.wavesAt": "{height} cada {seconds} sec",
  "buoys.pressure": "Presión",
  "buoys.water": "Agua",
  "buoys.air": "Aire",
  ...
  "rotationPeriod.4h": "4 horas",
  "rotationPeriod.24h": "1 día",
  "azShearLevel.low": "0 a 2 km",
  "azShearLevel.mid": "3 a 6 km",
  "azShearLevel.midNote":
    "Por encima de 10 aquí hay un mesociclón profundo, según la lectura del servicio meteorológico.",
  ...
  "layers.shiDetail":
    "La energía cinética del granizo de la que salen la probabilidad y el tamaño",
  "layers.poshDetail":
    "Probabilidad de MRMS de que el granizo que llega al suelo sea severo",
  "layers.viiDetail":
    "Cuánto hielo sostiene la columna por encima del nivel de congelación",
  ...
  "mrms.rotation30": "Trazas de rotación, últimos 30 min",
  "mrms.rotation120": "Trazas de rotación, últimas 2 horas",
  "mrms.rotation240": "Trazas de rotación, últimas 4 horas",
  "mrms.rotation1440": "Trazas de rotación, último día",
  "mrms.azShearLow": "Cizalladura azimutal, 0 a 2 km",
  "mrms.azShearMid": "Cizalladura azimutal, 3 a 6 km",
  "mrms.vilDensity": "Líquido por metro de columna",
  "mrms.shi": "Índice de granizo severo",
  "mrms.posh": "Probabilidad de granizo severo",
  "mrms.vii": "Hielo integrado verticalmente",
  ...
  "layers.note":
    "Cada interruptor se guarda al pulsarlo. Las alertas vienen del NWS, ECCC y DWD, los sismos del USGS y los perímetros de incendios del NIFC.",
  ...
  "ambientScreen.awakeUnavailable":
    "Solo Windows por ahora, así que aquí no hay ninguna pantalla que mantener encendida.",
  ...
  "watch.failed": "La vigilancia no llega al servicio",
  "watch.failedBody":
    "Ha fallado tres comprobaciones seguidas, así que un aviso donde vigilas podría no llegar. Sigue intentándolo.",
  "watch.recovered": "La vigilancia vuelve a llegar al servicio",
  "watch.recoveredBody":
    "Las comprobaciones responden de nuevo. No se ha perdido nada que siga vigente.",
  "watch.lastChecked": "Comprobado hace {age}",
  "watch.notReaching": "Las comprobaciones llevan {age} fallando",
  "guidance.gfs": "GFS",
  ...
  "tides.observed": "Medido {height}",
  "tides.observedAt": "En el mareógrafo, {time}",
  "tides.abovePrediction": "{height} por encima de los {predicted} previstos",
  "tides.belowPrediction": "{height} por debajo de los {predicted} previstos",
