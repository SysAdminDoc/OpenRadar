...
export const en = {
  ...
  "storm.status.TS": "Tropical storm",
  "storm.status.HU": "Hurricane",
  "storm.status.EX": "Extratropical",
  "storm.status.SD": "Subtropical depression",
  "storm.status.SS": "Subtropical storm",
  "storm.status.LO": "Low",
  "storm.status.WV": "Tropical wave",
  "storm.status.DB": "Disturbance",
  ...
  "wildfires.failed": "The NIFC fire service {answer}.",
  "hrrr.failed": "The forecast index {answer}.",
  "provider.failed": "The radar service {answer}.",
  "route.forecastFailed": "The forecast {answer}.",
  "search.failed": "Place search {answer}.",
  "weather.failed": "The forecast {answer}.",
  "replay.archiveFailed": "The warning archive {answer}.",
  "kmz.notZip": "That file is not a zip archive.",
  "kmz.noDecompressor": "This build cannot unpack a zip archive.",
  "kmz.tooBigUnpacked": "That archive unpacks to more than this will read.",
  ...
  "kml.notKml": "That file is not a KML document.",
  ...
  "flood.heading": "Flash flood panels",
  "flood.guide":
    "A guide from the Weather Service's four-panel method, not a warning. The warnings your office issues come first.",
  "flood.unavailable": "There are no flash flood grids for this place.",
  "flood.reading": "Reading the four flood grids.",
  "flood.panelMissing": "{panel}: no grid",
  "flood.qpeValue": "{inches} in of rain in the past hour",
  "flood.ariValue": "A {years}-year rain at worst",
  "flood.ratioValue": "{percent}% of flash flood guidance",
  "flood.streamflowValue": "Runoff {runoff} ft³/s/mi²",
  "flood.callAdvisory": "Three of the four panels reach the advisory level.",
  "flood.callWarning": "Three of the four panels reach the warning level.",
  "flood.callConsiderable":
    "Three of the four panels reach the considerable level.",
  "flood.callCatastrophic":
    "Three of the four panels reach the catastrophic level.",
  "flood.noCall": "Fewer than three panels agree, so no level is called.",
  "flood.inspect": "Flash flood panels: {panels}. {call}",
  "flood.thresholds": "Flash flood panels",
  "flood.thresholdsDetail":
    "The bars the four-panel call is read against, in the units the method writes them in. The defaults are the Weather Service's own, from the western Great Lakes.",
  "flood.panel": "Panel",
  "flood.panelQpe": "Rain in an hour",
  "flood.unitQpe": "inches",
  "flood.panelAri": "Return period",
  "flood.unitAri": "years",
  "flood.panelRatio": "Rain against guidance",
  "flood.unitRatio": "per cent",
  "flood.panelStreamflow": "Runoff",
  "flood.unitStreamflow": "ft³/s per square mile",
  "flood.tierAdvisory": "Advisory",
  "flood.tierWarning": "Warning",
  "flood.tierConsiderable": "Considerable",
  "flood.tierCatastrophic": "Catastrophic",
  "flood.barLabel": "{panel}, {tier}",
  "flood.mustClimb":
    "A panel's bars have to climb from advisory to catastrophic, so that one wasn't taken.",
  "flood.reset": "Put back the Weather Service's bars",
  "nearby.warningsHeld":
  ...
  "layers.groupHazards": "Warnings and hazards",
  "layers.groupRadar": "From the radar",
  "layers.groupWater": "Rain and flooding",
  "layers.groupLightning": "Lightning",
  "layers.groupSky": "Sky and air",
  "layers.groupReference": "Reference",
  "layers.groupYours": "Your own files",
  "layers.stateFresh": "up to date",
  "layers.stateFetching": "checking",
  "layers.stateStale": "old",
  "layers.stateFailed": "not answering",
  "layers.stateWaiting": "waiting",
  "layers.title": "Layers",
  ...
  "aviation.hazardConvective": "Thunderstorms",
  "aviation.hazardTurbulence": "Turbulence",
  "aviation.hazardTurbulenceHigh": "Turbulence, high level",
  "aviation.hazardTurbulenceLow": "Turbulence, low level",
  "aviation.hazardIcing": "Icing",
  "aviation.hazardIfr": "Low cloud or poor visibility",
  "aviation.hazardMountains": "Mountains obscured",
  "aviation.hazardShear": "Wind shear near the ground",
  "aviation.hazardSurfaceWind": "Strong surface wind",
  "aviation.hazardFreezingLevel": "Freezing level",
  "aviation.hazardFreezingLevels": "More than one freezing level",
  "aviation.hazardAsh": "Volcanic ash",
  "aviation.hazardMountainWave": "Mountain wave",
  "aviation.hazardTropicalCyclone": "Tropical cyclone",
  "aviation.hazardThunderstormHail": "Thunderstorms with hail",
  "aviation.hazardDustStorm": "Dust storm",
  "aviation.hazardSandstorm": "Sandstorm",
  "aviation.hazardRadioactiveCloud": "Radioactive cloud",
  "aviation.severityNone": "None reported",
  "aviation.severityTrace": "A trace",
  "aviation.severityTraceLight": "A trace to light",
  "aviation.severitySmoothLight": "Smooth to light",
  "aviation.severityHeavy": "Heavy",
  "aviation.severityModerateExtreme": "Moderate to extreme",
  "aviation.severitySevereExtreme": "Severe to extreme",
  "aviation.severityExtreme": "Extreme",
  ...
  "buoys.station": "Buoy {station}",
  "buoys.wind": "Wind",
  "buoys.windFrom": "{speed} from {from}°",
  "buoys.gusting": ", gusting {speed}",
  "buoys.waves": "Waves",
  "buoys.wavesAt": "{height} every {seconds} sec",
  "buoys.pressure": "Pressure",
  "buoys.water": "Water",
  "buoys.air": "Air",
  ...
  "layer.airnow": "Air Quality",
  "layers.airnowDetail":
    "What the monitors on the ground measured this hour, with the EPA's own index. An observation, unlike the forecast smoke beside it.",
  "keywords.airnow": "air quality aqi smoke ozone pollution pm25 breathe",
  "airnow.failed": "The air quality network {answer}.",
  ...
  "layers.firmsDetail":
    "Every pixel a satellite saw burning in the last day, hours before anybody draws a perimeter round it. From zoom 4 in.",
  "keywords.firms": "fire hotspot viirs satellite detection firms burning",
  "firms.failed": "The fire detections {answer}.",
  "firms.partial": "Drawn without {satellites}, which did not answer.",
  "firms.detection": "Hot pixel, {satellite}",
  "firms.confidence": "Confidence: {confidence}",
  "firms.power": "Radiating {power} MW",
  "firms.brightness": "Fire channel at {brightness} K",
  "firms.seen": "Seen at {time}",
  "firms.note":
    "A hot pixel, not a confirmed fire. Flares, furnaces and sun glint light one up too.",
  ...
  "gridWatch.notPublishedHere":
    "The network does not publish this grid everywhere you are watching, so this rule has nothing to read there.",
  ...
  "export.noMp4": "This build has no H.264 encoder, so it cannot write an MP4.",
  "export.mp4Reordered":
    "This machine's H.264 encoder reorders frames, which this build cannot package. The WebM export still works.",
  "export.mp4Missing": "No H.264 encoder here. The WebM above still works.",
  ...
  "ambientScreen.awakeUnavailable":
    "Windows only for now, so there is no screen for this to hold here.",
  ...
  "tides.observed": "Measured {height}",
  "tides.observedAt": "At the gauge, {time}",
  "tides.abovePrediction": "{height} above the {predicted} predicted",
  "tides.belowPrediction": "{height} below the {predicted} predicted",
